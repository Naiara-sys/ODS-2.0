...
CREATE TABLE metrica (
    ...
    CONSTRAINT uq_metrica_ods2
        UNIQUE (id_ods2, nombre)
);
...
CREATE TABLE evidencia (
    ...
    CONSTRAINT fk_evidencia_ods2
        FOREIGN KEY (id_ods2)
        REFERENCES ods_2(id_ods2),
    CONSTRAINT chk_fiabilidad
        CHECK (fiabilidad BETWEEN 0 AND 5),
    CONSTRAINT uq_evidencia_ods2
        UNIQUE (id_ods2, descripcion)
);
